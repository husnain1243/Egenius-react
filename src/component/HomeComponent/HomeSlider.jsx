        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src={banner1} class="d-block img-fluid w-100 h-100" alt="banner1"/>
                ...
                <div class="carousel-item">
                    <img src={banner2} class="d-block img-fluid w-100 h-100" alt="banner2"/>
                    <div class="carousel-caption">
                ...
                <div class="carousel-item">
                    <img src={banner3} class="d-block img-fluid w-100 h-100" alt="banner3"/>
                    <div class="carousel-caption">
                ...
                <div class="carousel-item">
                    <img src={banner4} class="d-block img-fluid w-100 h-100" alt="banner3"/>
                    <div class="carousel-caption">

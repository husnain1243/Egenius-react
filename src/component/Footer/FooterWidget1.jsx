                ...
                <ul className="list-unstyled d-flex flex-column gap-3 my-3"  style={{fontSize: "18px"}}>
                    <li>
                        <a href="tel:+923164604121">
                            ...
                            <p className="d-inline mx-2">92-316-4604121</p>
                        </a>
                    </li>
                    <li>
                        <a href="mailto:husnainmohammad16@gmail.com">
                            ...
                            <p className="d-inline mx-2">husnainmohammad16@gmail.com</p>
                        </a>
                    </li>
                    <li>
                        <a>
                            ...
                            <p className="d-inline mx-2">Lahore, pakistan</p>
                        </a>
                    </li>
                </ul>
            </div>
